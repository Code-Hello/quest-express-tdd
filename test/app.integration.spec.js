...
describe("Test routes", () => {
    ...
    it("POST /bookmarks error if fields are missing", (done) => {
        request(app)
            .post("/bookmarks")
            .send({})
            .expect(422)
    ...
    it("POST /bookmarks success if fields are filled", (done) => {
        request(app)
            .post("/bookmarks")
    ...
    describe("GET /bookmarks/:id", () => {
        ...
        it("GET /bookmarks/:id error if bad id", (done) => {
            request(app)
                .get("/bookmarks/5")
                .expect(404)
                .expect("Content-Type", /json/)
        ...
        it("GET /bookmarks/:id success if good id", (done) => {
            request(app)
                .get("/bookmarks/1")
                .expect(200)
                .expect("Content-Type", /json/)
